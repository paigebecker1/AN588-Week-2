...
```{r}
a[1:5, 1:5, 3, 3] 
# great job on these previous two challenges. really concise code and really easy to follow bite sized chunks. 
```
...
# great job! I did this the exact same way. I think it would be beneficial to explain a in a little more detail which each line of code does for future references. 
```
Okay, I think I did this successfully, but it's not very pretty. I'd love to learn how to make it look prettier.  
ugh i want mine to look prettier so bad - sofia 
...
str(df_m3)
# we did this the same way I think! great job. I think this challenge was pretty straightforward. 
```

Great code, Paige. It was easy to follow and I really enjoyed reading your comments and think it's really useful to reflect on coding while you're doing it. I think I will probably implement this in my future challenges and homework assignments. 
