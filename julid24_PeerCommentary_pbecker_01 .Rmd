...
<!-- JD: I think it's interesting how you chose to start the sequence from=3, the actual third word, rather than 0. There are many different ways to approach this challenge! Nice work! -->
...
<!-- JD: Great job on Challenge 2! You set up your functions for extracting rows/columns differently than I did, and it seems so much easier. This taught me something new - thanks! :) -->
# Challenge 3
...
<!-- JD: The 4-D concept was confusing for me, too. I admire your dedication to checking your work by searching the actual matrix. Great catch, and now we know how the 4-d array is formatted. -->
a[2, 3, 2, ]  
364, 264, 164, 64  
...
<!-- JD: Great job here. This was definitely challenging with all the nesting. Just 1 thing - for this primate taxonomy list, you are missing Tarsioidea which is a subgroup of Haplorhini.   -->
...
str(df_m3)
```
<!-- JD: Paige, you did a really great job on this! I admire your thorough work, and it is clear that you really want to understand the concepts and functions. Don't forget to add Tarsioidea to your primate taxonomy tree! P.S. thanks for the tip on leaving comments :) -->
